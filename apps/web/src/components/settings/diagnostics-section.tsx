...
export function DiagnosticsSection() {
  return (
    <section className="animate-in fade-in slide-in-from-bottom-2 duration-300 space-y-8">
      ...
      <div>
        <h3 className="text-lg font-medium text-[var(--text-primary)] mb-4">Debug Logs</h3>
        <div className="glass-card p-4 rounded-xl border border-[var(--border-glass)]">
          ...
          <div className="mt-4 flex justify-end">
            <button className="px-4 py-2 rounded-lg text-xs font-semibold text-[var(--text-primary)] btn-glass bg-[var(--surface-glass-faint)] border border-[var(--border-glass)] hover:bg-[var(--surface-glass)] hover:text-[var(--accent-primary)] hover:border-[color-mix(in srgb,var(--accent-primary)_35%,transparent)] transition-all cursor-pointer">
              Export Logs
            </button>
          </div>
        </div>
