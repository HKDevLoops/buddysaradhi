...
CREATE TABLE IF NOT EXISTS settings (
  ...
  currency_code           TEXT NOT NULL DEFAULT 'INR' CHECK(currency_code IN ('INR','USD','EUR','GBP','AED')),
  locale                  TEXT NOT NULL DEFAULT 'en-IN',
  timezone                TEXT NOT NULL DEFAULT 'Asia/Kolkata',
  default_fee_model       TEXT NOT NULL DEFAULT 'postpaid' CHECK(default_fee_model IN ('postpaid','prepaid','mixed')),
...
CREATE TABLE IF NOT EXISTS tutors (
  ...
  email        TEXT,
  phone        TEXT,
  role         TEXT NOT NULL DEFAULT 'tutor' CHECK(role IN ('owner','tutor','assistant')),
...
CREATE TABLE IF NOT EXISTS students (
  ...
  fee_model       TEXT NOT NULL DEFAULT 'postpaid' CHECK(fee_model IN ('postpaid','prepaid','mixed')),
...
CREATE TABLE IF NOT EXISTS app_state (
  tenant_id        TEXT PRIMARY KEY,
  schema_version   INTEGER NOT NULL,
  app_lock_state   TEXT NOT NULL DEFAULT 'unlocked' CHECK(app_lock_state IN ('unlocked','locked')),
  app_lock_until   TEXT,
  last_backup_at   TEXT,
  last_export_at   TEXT,
  last_sync_at     TEXT,
