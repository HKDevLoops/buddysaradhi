...
-- Create virtual table for FTS5 (for the search)
...
-- Triggers to update the FTS5 table
CREATE TRIGGER IF NOT EXISTS trg_students_fts_insert AFTER INSERT ON students
BEGIN
  INSERT INTO students_fts(rowid, first_name, last_name, code, phone, email, school, grade)
  VALUES (new.rowid, new.first_name, new.last_name, new.code, new.phone, new.email, new.school, new.grade);
END;

CREATE TRIGGER IF NOT EXISTS trg_students_fts_delete AFTER DELETE ON students
BEGIN
  INSERT INTO students_fts(students_fts, rowid, first_name, last_name, code, phone, email, school, grade)
  VALUES ('delete', old.rowid, old.first_name, old.last_name, old.code, old.phone, old.email, old.school, old.grade);
END;

CREATE TRIGGER IF NOT EXISTS trg_students_fts_update AFTER UPDATE ON students
BEGIN
  INSERT INTO students_fts(students_fts, rowid, first_name, last_name, code, phone, email, school, grade)
  VALUES ('delete', old.rowid, old.first_name, old.last_name, old.code, old.phone, old.email, old.school, old.grade);
  INSERT INTO students_fts(rowid, first_name, last_name, code, phone, email, school, grade)
